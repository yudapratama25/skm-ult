...
<html lang="en">
  ...
  <body>
                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-md-3 me-2">
                            <div class="card card-user" onclick="window.location.href=`{{ url('/kuesioner') }}`">
                                <div class="card-body">
                                    <img src="{{ asset('images/visitor-skm.png') }}" alt="Pengunjung" class="w-100">
                                    <h6 class="text-center mt-2 mb-0">Pengunjung</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 ms-2">
                            <div class="card card-user" onclick="showFormLogin()">
                                <div class="card-body">
    ...
    <script>
        const myModalAlternative = new bootstrap.Modal('#modalLoginAdmin');
